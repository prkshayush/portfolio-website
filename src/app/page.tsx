    ...
    <main>
      <div className="flex-col md:flex lg:flex md:flex-row lg:flex-row items-center justify-between gap-x-32 my-14 gap-20 p-20">
        <div className="flex-1 flex items-center flex-col cursor-pointer gap-5 lg:gap-10">
          ...
          <h4 className="text-base lg:text-2xl font-normal text-justify">I'm <span className='hover:text-light-blue transition-all delay-75'>Ayush Prakash👋</span>. I'm interested in Tech, Music, Sports & Adventure. I'm a self-taught developer experienced with Front-End | Backend, learning & exploring Machine Learning & CI/CD.
